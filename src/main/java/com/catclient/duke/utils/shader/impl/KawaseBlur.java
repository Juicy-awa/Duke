package com.catclient.duke.utils.shader.impl;
...
import com.catclient.duke.utils.timer.TimerUtils;
import com.catclient.duke.utils.shader.Framebuffer;
import com.catclient.duke.utils.shader.PostProcessRenderer;
import com.catclient.duke.utils.shader.Shader;
import com.catclient.duke.utils.shader.ShaderHelper;
...
public class KawaseBlur {
    ...
    public void draw(int radius) {
        ...
        if (Duke.getInstance().getModuleManager().getModule(HUD.class).fastBlur.get()) {
            if (timer.delay(16)) {
                timer.reset();
            } else {
                return;
