package com.catclient.duke.utils.skia.font;

import com.catclient.duke.utils.skia.utils.SkiaUtils;
...
public class FontHelper {
    ...
    private static Typeface loadTypeface(String font, FontType type) {
        Optional<Data> fontDataOptional = SkiaUtils.convertToData("/Duke/fonts/" + font);
